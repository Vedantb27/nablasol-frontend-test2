...
function CreateAccount() {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-r from-purple-400 to-blue-400 p-4">
            ...
            <div className="bg-white shadow-lg rounded-lg pl-8 pr-8 pb-8  max-w-5xl w-full">
                <div className="flex justify-between  ">
                    <div className="text-blue-600  bg-sky-500 font-medium text-center md:text-2xl text-white flex border rounded-r-3xl w-full h-16 flex justify-center items-center">
                        <span className='border rounded-full w-8 h-8 flex items-center justify-center'>
                            1
                        </span> Your Profile
                    </div>
                    <div className="text-blue-600 font-medium text-center md:text-2xl flex  text-slate-300 w-full ml-6 mr-6 flex justify-center items-center">
